    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-100 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          ...
          <CardDescription>
            Créez votre compte Agent CRM et gérez vos clients en assurance
          </CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <label htmlFor="tenant_name" className="text-sm font-medium">Nom du cabinet</label>
              <Input
                id="tenant_name"
                name="tenant_name"
                type="text"
                placeholder="Mon Cabinet d'Assurance"
                required
                disabled={loading}
              />
            </div>
